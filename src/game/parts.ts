...
export const PARTS: Part[] = [
  ...
  // --- Passive arsenal (iteration 7) ---
  {
    ...
    name: 'Gauss lance',
    type: 'weapon',
    description: '1 cannon die, 2 damage, ignores 2 points of enemy shield',
    cost: 6,
  ...
  },
  {
    ...
    type: 'shield',
    description: '+1 shield. Active (1/combat): this round, all your ships gain +2 shield.',
    cost: 7,
    shield: 1,
    active: true,
  },
  {
    ...
    type: 'shield',
    description:
      '+1 shield. Active (1/combat): this round, natural 6s against this ship are not automatic hits — they resolve as normal rolls.',
    cost: 7,
    shield: 1,
    active: true,
  },
